...
-- Returns 27 rows if 
-- Jerimiah Pendegrass is not deleted in the DML.
-- +------------+---------------+-----------+-----------+
-- | roomnumber | reservationid | baseprice | totalcost |
-- +------------+---------------+-----------+-----------+
-- |        201 |             4 |    199.99 |    199.99 |
...
-- Returns 2 rows if Jeremiah Pendergrass is not deleted in the DML...
-- +---------------+------------+------------------+------------+------------+
-- | reservationid | roomnumber | maximumoccupancy | startdate  | enddate    |
-- +---------------+------------+------------------+------------+------------+
-- |             8 |        304 |                4 | 2023-03-31 | 2023-04-05 |
-- |             9 |        301 |                4 | 2023-04-09 | 2023-04-13 |
-- +---------------+------------+------------------+------------+------------+
...
-- Returns 12 rows if
-- Jeremiah Pendergrass is not deleted in the DML...
-- +-----------+-------------+------------------------+
-- | firstname | lastname    | reservations_per_guest |
-- +-----------+-------------+------------------------+
-- | Mack      | Simmer      |                      4 |
